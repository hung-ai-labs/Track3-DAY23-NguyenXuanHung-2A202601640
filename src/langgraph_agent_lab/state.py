...
class AgentState(TypedDict, total=False):
    ...
    Scalar workflow decisions are overwritten by the node that owns them. Lists use
    LangGraph's append reducer so every message, tool result, error, and audit event
    remains available for checkpoint replay and grading.
    """
